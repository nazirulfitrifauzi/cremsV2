...
@section('content')
    ...
    @else  
        @include('users.partials.header', ['title' => 'Claim List'])  
    @endif
                ...
                <div class="card shadow" style="padding-bottom:20px;">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                            <h3 class="mb-0">{{ now()->format('F Y') }} Claim List</h3>
                            </div>
                            @if (auth()->user()->role == '1')
                            @else
                                <div class="col-4 text-right">
                                    <a href="{{ route('staff-claim.create') }}" class="btn btn-sm btn-primary">Request Claim</a>
                                </div>
                            @endif
                        </div>
                    </div>
