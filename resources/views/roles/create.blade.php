...
@section('content')
    @include('users.partials.header', ['title' => 'Add Role'])   
                        ...
                        <form method="post" action="{{ route('roles.store') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('role') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="role" id="input-name" class="form-control form-control-alternative{{ $errors->has('role') ? ' is-invalid' : '' }}" placeholder="Role" value="{{ old('role') }}" required autofocus>
                                ...
                                <table width="100%">
                                    <tr>
                                        <td width="25%">
                                            ...
                                            <input class="custom-control-input" id="attendance" name="p_attendance" type="checkbox" value="1">
                                                <label class="custom-control-label" for="attendance">Attendance</label>
                                            </div>
                                        </td>
                                        <td width="25%">
                                            <div class="custom-control custom-checkbox mb-3">
                                                <input class="custom-control-input" id="leave" name="p_leave" type="checkbox" value="1">
                                                <label class="custom-control-label" for="leave">Leave</label>
                                            </div>
                                        </td>
                                        <td width="25%">
                                            <div class="custom-control custom-checkbox mb-3">
                                                <input class="custom-control-input" id="claim" name="p_claim" type="checkbox" value="1">
                                ...
                                <table width="100%">
                                    <tr>
                                        <td width="25%">
                                            <div class="custom-control custom-checkbox mb-3">
                                            <input class="custom-control-input" id="roles" name="p_roles" type="checkbox" value="1">
                                                <label class="custom-control-label" for="roles">Roles</label>
                                            </div>
                                        </td>
                                        <td width="25%">
                                            <div class="custom-control custom-checkbox mb-3">
                                            <input class="custom-control-input" id="staff" name="p_staff" type="checkbox" value="1">
                                                <label class="custom-control-label" for="staff">Staff</label>
                                            </div>
                                        </td>
                                        <td width="25%">
                                            <div class="custom-control custom-checkbox mb-3">
                                            <input class="custom-control-input" id="client_company" name="p_client_company" type="checkbox" value="1">
                                                <label class="custom-control-label" for="client_company">Company List</label>
                                            </div>
                                        </td>
                                        <td width="25%">
                                            <div class="custom-control custom-checkbox mb-3">
                                            <input class="custom-control-input" id="client_user" name="p_client_user" type="checkbox" value="1">
