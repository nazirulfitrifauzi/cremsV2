                ...
                <div class="card shadow" style="padding-bottom:20px;">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">All Staff List</h3>
                            </div>
                            <div class="col-4 text-right">
                                <a href="{{ route('staff.create') }}" class="btn btn-sm btn-primary">Add Staff</a>
                            </div>
                        </div>
                    </div>
        ...
        "columns":[
            ...
            { render:function(data, type, row){
                return   '<div style="float:right;">' +              
                        '<a class="btn btn-success" href="staff/'+ row.id +'/edit" style="padding:5px;">' +
                            '<i class="fas fa-edit" style="margin-right:0px;"></i> Edit' +
                            '<div class="ripple-container"></div>' +
                        '</a>' +
                        '<a class="btn btn-danger" onclick="deleteStaff(' + row.id + ')" style="padding:5px;color:white;">' +
